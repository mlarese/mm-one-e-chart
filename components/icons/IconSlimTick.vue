<template>
    <svg xml:space="preserve" style="enable-background:new 0 0 199.943 199.943;" viewBox="0 0 199.943 199.943" y="0px" x="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" class="svg-ico" version="1.1">
        <g>
        <g>
          ...
          <path d="M99.324,67.354c-3.708,0-6.725,3.01-6.725,6.728v75.979c0,3.722,3.017,6.739,6.725,6.739
            ...
            <circle r="8.178" cy="48.697" cx="99.746"/></g>
        </g>
    </svg>
</template>
